  ...
  return (
    <div className="sideBar">
      <Link to="/">
        ...
        >
          <i className="bi bi-house sideIcons"></i>
      ...
      <Link to="/search">
        ...
        >
          <i className="bi bi-search sideIcons"></i>
          <span className="sideBarLabel">Search</span>
        </div>
      </Link>
      <Link to="/browse">
        <div
        ...
        >
          <i className="bi bi-folder sideIcons"></i>
          <span className="sideBarLabel">Browse</span>
        </div>
      </Link>
      <Link to="/analytics">
        <div
        ...
        >
          <i className="bi bi-graph-up sideIcons"></i>
          <span className="sideBarLabel">Analytics</span>
        </div>
      </Link>
      {/* <Link to="/analytics">
      ...
      <Link to="/manage">
        ...
        >
          <i className="bi bi-gear sideIcons"></i>
          <span className="sideBarLabel">Manage</span>
        </div>
      </Link>
      ...
      <Link to="/sprint-hub-app">
        ...
        >
          <i className="bi bi-shield-lock sideIcons"></i>
